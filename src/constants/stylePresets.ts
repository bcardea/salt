...
export const STYLE_PRESETS: StylePreset[] = [
  ...
  promptModifiers: `{
    ...
    "composition": "The design is vertically divided: the lower half features the father (facing away) holding up his child, who is also looking away, both positioned slightly to the right of center. The upper half is filled with a wide expanse of sky and clouds. The enormous '{sermon_title}' title is placed across the very top, flush left, with its right edge overlapping the father and child's heads. The wheat field creates a base, the figures anchor the composition, and the text draws the eye upward.",
    "color_palette": {
      "sky_blue": "#87bdd8",
      "cloud_white": "#f7f5ed",
      "wheat_gold": "#f1ce69",
    ...
    "lighting": "Natural daylight with a soft, warm glow from the upper left. Shadows are subtle and diffuse. The overall feel is airy, bright, and sunlit, with gentle highlights on the wheat and clothing.",
    "mood": "Uplifting, sentimental, and sincere—evoking the joy and security of a father-child relationship. The open landscape and clear sky symbolize freedom, hope, and future possibilities.",
    "texture": [
      "Photorealistic soft focus on background clouds",
      "Fine detail and gentle folds in the father's denim shirt",
      "Crisp, sunlit wheat stalks in the foreground",
      "Smooth sans-serif text with hard digital edges and no shadow"
    ],
    "background": {
      "elements": [
        "Expansive bright blue sky filling the upper two-thirds",
        "Puffy cumulus clouds spread across the sky",
        "Flat golden wheat field forming the bottom quarter of the image"
      ],
      "depth_of_field": "Slight background blur on distant clouds and field edge; sharp focus on main figures"
    },
    "subjects": [
      {
        "type": "figure_group",
        "description": "Father with child on shoulders, both seen from behind. The father wears a loose-fitting light blue denim shirt and tan pants. The child (young boy) wears a matching blue shirt and shorts, with his hands held up by the father. The child's legs drape on either side of the father's head.",
        "position": "right of center, standing amid wheat"
      }
    ],
    "graphic_elements": [],
    "typography": {
      "title": {
        "text": "{sermon_title}",
        "font": "Ultra-bold geometric sans-serif (e.g., Bebas Neue, League Spartan)",
        "weight": "heavy",
        "size": "extra large, spanning nearly the full width",
        "color": "white",
        "letter_spacing": "tight",
        "position": "top of the image, slightly overlapping the figures"
      },
      "subtitle": null
    },
    "style": "Modern photographic poster with editorial, magazine-like headline placement. Combines lifestyle photography with high-impact text for social media, print, or church event promotion.",
    "post_processing": [
      "Brightness and contrast adjustment for sunlit effect",
      "Slight vignette around edges for visual focus",
      "No added grain or filter; clean, contemporary look"
    ]
  }`,
  previewUrl: "https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/682bc054f08c4661e15c9407.jpeg",
  referenceUrl: "https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/682bc054f08c4661e15c9407.jpeg"
},
