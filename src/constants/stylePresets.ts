...
I'm going to give you directions to add more presets, do not change our code structure or flow in any way other than adding these new presets to the top of the list, I should be able to copy what you create and drop it in my working code bank and have it work perfect because you understand how we're currently using style presets. Here are the instructions:

Alright here comes some new style presets, always replace the titles and all text with {} just like the other styles and how you've done it in the past. I tried this before and you summarized the prompts, keep them JSON exactly like 

"Folded Paper Minimal" Preview and Ref url: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f22e5ca6c4b88f32b74.jpeg
Prompt Modifier: {
  "scene": "flat, neutral-toned paper background with subtle center fold lines and minute grain texture",
  ...
  "subjects": [
    {
      "type": "typographic element",
      "description": "centered text 'Life by Design' in geometric sans-serif typeface (e.g., Circular, Avenir, or similar)",
      "position": "center-left"
    },
    {
      "type": "label block",
      "description": "solid yellow rectangular badge with uppercase microtype reading 'Following God's Plan",
      "position": "bottom-right"
    },
...
"Vintage Floral" Preview and Ref URL: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f22d083852cb5168da6.jpeg
Prompt Modifier: {
  "scene": "centered symbolic illustration of a broken clay vase with flowers, placed within an arched gold frame on a deep navy background",
  "image_dimensions": "1024×768",
  "aspect_ratio": "4:3 landscape",
  ...
  "subjects": [
    ...
    {
      "type": "bouquet",
      "description": "wildflower arrangement with daisies, roses, hydrangea, and green stems, rising from vase",
      "position": "center"
    },
    {
      "type": "typographic element",
      "description": "scripted phrase 'RUSTED IDOLS' across middle",
      "position": "overlapping the vase midsection"
    },
    {
      "type": "text block",
      "description": "'A SERIES ON HUMANITY' in uppercase minimalist sans-serif",
      "position": "bottom center"
    }
  ],
  "graphic_elements": [
...
"Neon Compass": Preview and Ref url: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f22954010514b79671c.jpeg
Prompt Modifier: {
  "scene": "hand holding a compass, layered under glowing vintage typography on a neon duotone background with scratched light streak texture",
  "image_dimensions": "1365×768",
  "aspect_ratio": "16:9 landscape",
  "composition": "center-focused with large title text over compass image; subtitle aligned underneath; repeat text in corners for rhythm",
  "color_palette": {
    "main_duotone": ["#a04ce3", "#3b51d0"],
  ...
  "subjects": [
    ...
    {
      "type": "typographic element",
      "description": "'DIRECTION' in luminous serif with swash embellishments",
      "position": "center"
    },
    {
      "type": "typographic element",
      "description": "'NAVIGATING YOUR FAITH' in simple all-caps sans-serif font",
      "position": "below title"
    }
  ],
  "graphic_elements": [
    {
      "type": "repeat text",
      "description": "faded duplicated text 'SEEK YE FIRST' in upper-right and lower-left corners",
      "position": "corner faded overlays"
    }
  ],
  "typography": {
    "hierarchy": [
      {
        "text": "{DIRECTION}",
        "font": "flared serif with high contrast (e.g., Lust, Recoleta)",
        "weight": "light",
        "size": "very large",
        "color": "#ffffff",
        "letter_spacing": "tight",
        "case": "uppercase with swashes",
        "position": "center"
      }
    ],
    "subtitle": {
      "text": "{NAVIGATING YOUR FAITH}",
      "font": "modern sans-serif",
      "weight": "medium",
      "size": "small",
      "color": "#ffffff",
...
"Neon Pastel" Preview and Ref URL: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f22d083855a19168da7.jpeg
Prompt Modifier: {
  "scene": "calming, pastel-hued sky gradient fading from light lavender to peach and blue, suggesting dawn or spiritual awakening",
  "image_dimensions": "1365×768",
  "aspect_ratio": "16:9 landscape",
  ...
  "subjects": [
    {
      "type": "line illustration",
      "description": "white outline of praying hands, fingers upright and overlapping, in traditional prayer pose",
      "position": "centered behind main title text"
    },
    {
      "type": "typographic element",
      "description": "'THE LORD'S PRAYER' in uppercase, elegant high-contrast serif font",
      "position": "center middle"
    },
    {
      "type": "typographic element",
      "description": "'OUR FATHER WHO ART IN HEAVEN' in spaced all-caps sans-serif",
      "position": "below main title, center-aligned"
    }
  ],
  "graphic_elements": [],
    ...
    "hierarchy": [
      {
        ...
        "font": "refined serif (e.g., Playfair Display, Libre Baskerville)",
        "weight": "medium",
        "size": "large",
        "color": "#2e2e2e",
        "letter_spacing": "slight",
...
"Retro Revival" Preview and Ref URL: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f22a6cf15956b66dbe5.jpeg
Prompt Modifier: {
  "scene": "centered revival-style print featuring praying hands with typographic layering on a textured off-white background",
  ...
  "background": {
    "elements": [
      "light paper texture in cream tone",
      "no gradients or photographic components"
    ],
    "depth_of_field": "flat illustrative depth"
  },
  "subjects": [
    {
      "type": "illustration",
      "description": "engraved praying hands in red, palms together with cuffs visible, surrounded by radiating red lines",
      "position": "center"
    },
    {
      "type": "typographic element",
      "description": "'FOR GOD' arched above hands in blue uppercase sans-serif",
      "position": "top arc"
    },
    {
      "type": "typographic element",
      "description": "'SO' and 'LOVED' in blue uppercase on left and right sides, horizontally aligned below hands",
      "position": "horizontal base"
    },
    {
      "type": "typographic element",
      "description": "'you.' in expressive yellow cursive overlapping center",
      "position": "center overlay"
    },
    {
      "type": "auxiliary text",
      "description": "'JOHN 3:16' in vertical stacks on left and right sides in small blue caps",
      "position": "outer flanks"
    }
  ],
  "graphic_elements": [
    {
      "type": "radial burst",
      "description": "thin red lines radiating outward behind hands to suggest divine energy or focus",
      "position": "centered behind illustration"
    }
  ],
  "typography": {
...
"Vintage Hoops" Prev and Ref url: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f228acc4aeb7bb7e7c0.jpeg
Prompt Modifier: {
  "scene": "layered vintage backdrop blending an ancient world map with starry outer space textures; central panel shaped like a medieval shield or stone tablet",
  "image_dimensions": "1365×768",
  "aspect_ratio": "16:9 landscape",
  ...
  "background": {
    "elements": [
      "celestial star field with white speckles in outer border",
      "old-world map of ancient Corinth faintly visible behind central panel",
      "slight sepia tint on edges suggesting wear and age"
    ],
    "depth_of_field": "flat depth; all layers in sharp focus to maintain collage clarity"
  },
  "subjects": [
    {
      "type": "text block",
      "description": "bold retro-styled title text 'CHOICES'",
      "font": "condensed block serif with angled shadows",
      "position": "centered top-middle"
    },
    {
      "type": "text block",
      "description": "subtitle 'HIS WAY OR THE WORLD?' in smaller arched serif",
      "font": "narrow serif, slightly curved layout",
      "position": "just below title, curved upward"
    },
    {
      "type": "text block",
      "description": "'A SERIES ON CORINTHIANS' in small uppercase sans-serif",
      "font": "modern geometric sans-serif",
      "position": "bottom third, centered"
    },
    {
      "type": "basketball hoop",
      "description": "retro-styled basketball hoop and net, slightly stylized",
      "pose": "front-facing, integrated into design rather than photorealistic",
      "position": "centered at bottom"
    }
  ],
  "graphic_elements": [
    {
      "type": "starburst",
      "description": "hand-drawn white 8-point stars with uneven rays",
      "position": "left and right of the title text"
    },
    {
      "type": "wireframe globe icon",
    ...
    {
      "type": "distorted checkerboard",
      "description": "curved checker patterns in brown and black flowing from top-right and bottom-left corners",
      "position": "diagonal corners, perspective warp effect"
    }
  ],
  "typography": {
    "hierarchy": [
    ...
    "subtitle": {
      "text": "{HIS WAY OR THE WORLD?}",
      "font": "serif with curve arch layout",
      "weight": "bold",
      "size": "medium",
      "color": "#f1f1f1",
      "letter_spacing": "wide",
  ...
  "post_processing": [
    ...
    "paper grain overlay",
    "light starfield blur around corners",
    "text edges slightly darkened for visual punch"
  ]
}

"Ancient Maps" Prev and Ref url: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f22954010809c79671d.jpeg
Prompt Modifier: {
  "scene": "antique parchment map background centered on Corinth region, faintly labeled with aged, classical text and hand-drawn geographic lines",
  "image_dimensions": "1365×768",
  "aspect_ratio": "16:9 landscape",
  ...
  "background": {
    "elements": [
      "ancient map labeling Peloponnesus, Corinth, and surrounding regions",
      "light brown-beige textured paper surface",
      "scattered faint geographic lines and coastal outlines"
    ],
    "depth_of_field": "flat print design, no depth blur"
  },
  "subjects": [
    {
      "type": "typographic element",
      "description": "word 'CHOICES' in bold varsity-style font with upward arch, black-to-green gradient, sharp drop shadow",
      "position": "centered upper-middle"
    },
    {
      "type": "typographic element",
      "description": "'HIS WAY OR THE WORLD?' in condensed slab serif arched underneath title, outlined in dark shadow",
      "position": "centered below title"
    },
    {
      "type": "icon",
      "description": "globe symbol with latitude-longitude lines, monochrome black, hand-drawn look",
      "position": "center of lower-middle, directly beneath subtitle"
    },
    {
      "type": "text block",
      "description": "'A SERIES ON CORINTHIANS' in all caps sans-serif",
      "position": "bottom center"
    },
    {
      "type": "illustration",
      "description": "black bird in flight, beak touching starburst mark, vintage engraving style",
      "position": "top-left"
    },
    {
      "type": "illustration",
      "description": "partially visible globe of Earth, etched lines and dark shading",
      "position": "top-right"
    },
    {
      "type": "illustration",
      "description": "old steepled church in engraving style, bold dark outlines",
      "position": "bottom-left"
    },
    {
      "type": "illustration",
      "description": "ruined classical column base or architectural relic, aged and cracked",
      "position": "bottom-right"
    }
  ],
  "graphic_elements": [
    {
      "type": "starburst",
      "description": "white eight-point radial bursts placed near bird and column for visual emphasis",
      "color": "#ffffff",
      "position": "top-left and bottom-right corners"
    }
  ],
...
"TROPICAL EASTER" Prev and Ref url: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f22e5ca6c6882f32b73.jpeg
Prompt Modifier: {
  "scene": "dense tropical foliage bursting with detailed leaves and vibrant blossoms over a deep forest green background",
  "image_dimensions": "1024×768",
  "aspect_ratio": "4:3 landscape",
  ...
  "texture": [
    "hand-etched botanical detailing on all plant forms",
    "subtle grain overlay across entire piece for depth",
    "fine pen-style crosshatching in wildlife and florals"
  ],
  "background": {
    "elements": [
      "large banana and palm leaves with visible vein lines",
      "layered fronds and curling vines intertwined throughout",
      "rich green base with no sky visible, dense organic surround"
    ],
    "depth_of_field": "uniform clarity, slight overlap depth from layered leaves"
  },
  "subjects": [
    {
      "type": "typographic element",
      "description": "text 'MADE NEW' in bold, clean geometric sans-serif; 'E' stylized with open semicircle stroke suggesting growth",
      "position": "centered upper-middle"
    },
    {
      "type": "typographic element",
      "description": "'CELEBRATE EASTER' in uppercase sans-serif, smaller size beneath title",
      "position": "centered below title"
    },
    {
      "type": "bird",
      "description": "small songbird with olive and brown feathers, perched on slender twig",
      "position": "bottom-right quadrant"
    },
    {
      "type": "butterfly",
      "description": "pale green butterfly with ivory accents and patterned wings",
      "position": "top-right quadrant"
    }
  ],
  "graphic_elements": [
    {
      "type": "floral clusters",
      "description": "highly detailed groupings of tropical blooms in pink, coral, yellow, and orange",
      "position": "dispersed throughout corners and side edges"
    }
  ],
  "typography": {
    "hierarchy": [
      {
        "text": "{MADE NEW}",
        "font": "geometric sans-serif (e.g., Gotham, Avenir Next)",
        "weight": "bold",
        "size": "large",
        "color": "#f1ede4",
        "letter_spacing": "wide",
  ...
  "post_processing": [
    "slight color burn to enhance saturation of florals",
    "uniform matte filter over entire artwork for cohesive tone",
    "no shadow effects—flat layered illustrations for clean print look"
  ]
}

"Retro Cartoon Fruit" Pref and Ref URL: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f22a6cf15107266dbe2.jpeg
Prompt Modifier: {
  "scene": "cheerful lineup of colorful cartoon fruit characters on a lightly textured vintage paper background",
  "image_dimensions": "1024×768",
  "aspect_ratio": "4:3 landscape",
  ...
  "lighting": "flat cel-shading with slight drop shadow under characters; classic comic lighting",
  "mood": "fun, energetic, nostalgic, designed to evoke childlike joy and retro animation flair",
  "texture": [
    "fine linen paper grain texture across entire background",
    "halftone-style shadow under characters for depth"
  ...
  "background": {
    "elements": [
      "off-white textured paper backdrop",
      "scattered star sparkles in white between characters"
    ],
    "depth_of_field": "uniform flat illustration"
  },
  "subjects": [
    {
      "type": "fruit character",
      "description": "green pear with leaf hat, waving and smiling",
      "pose": "left fist up, right foot forward",
      "position": "far left"
    },
    {
      "type": "fruit character",
      "description": "yellow mango with high-top shoes, big smile",
      "pose": "right fist up, side stance",
      "position": "left-center"
    },
    {
      "type": "fruit character",
      "description": "peach with brown stem, facing viewer",
      "pose": "arms up, walking",
      "position": "center-left"
    },
    {
      "type": "fruit character",
      "description": "red apple with happy grin, stem and leaf on head",
      "pose": "right hand waving, slight twist",
      "position": "center"
    },
    {
      "type": "fruit character",
      "description": "orange with top leaves, eyes wide open",
      "pose": "hand on hip, one hand up",
      "position": "center-right"
    },
    {
      "type": "fruit character",
      "description": "red strawberry, confident pose",
      "pose": "thumbs up and stepping forward",
      "position": "far right"
    }
  ],
  "graphic_elements": [
  ...
  "typography": {
    "hierarchy": [
      {
        ...
        "font": "bold retro comic block with thick outline",
        "weight": "heavy",
        "size": "extra large",
        "color": "fill: #f7e7c6, outline: #1a6c87",
        "letter_spacing": "tight",
    ...
    "footer": {
      "text": "{Love, Joy, Kindness, Goodness...}",
      "font": "all caps condensed sans-serif",
      "weight": "regular",
      "size": "small",
      "color": "#07586c",
  ...
  "post_processing": [
    "subtle paper crease overlay",
    "slight drop shadow under characters",
    "muted halftone shading under base line"
  ]
}

"Retro Gym Poster" Prev and Ref url: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291f22a6cf150d4f66dbe3.jpeg
Prompt Modifier: {
  "scene": "centered minimalist layout with crossed boxing gloves illustration on a red textured background",
  "image_dimensions": "1365×768",
  "aspect_ratio": "16:9 landscape",
  ...
  "lighting": "flat poster-style lighting with no realistic shadows; all emphasis on color and illustration contrast",
  "mood": "resolute, commanding, spiritually militant and motivational",
  "texture": [
    "gritty red stucco or wall texture throughout background",
    "fine crosshatch engraving style on boxing gloves crossed",
    "paper-like matte finish to typography"
  ],
  "background": {
    "elements": [
      "solid red wash with grunge overlay texture",
      "no objects or symbols beyond the cross tools"
    ],
    "depth_of_field": "flat, screenprint effect"
  },
  "subjects": [
    {
      "type": "illustration",
      "description": "Vintage boxing gloves crossed at 45-degree angles, black-blue ink linework",
      "position": "dead center"
    },
    {
      "type": "typographic element",
      "description": "'SPIRITUAL WARFARE' in bold all-caps sans-serif, spaced for balance",
      "position": "centered over boxing gloves"
    },
    {
      "type": "typographic element",
      "description": "'FIGHT THE GOOD FIGHT' in clean uppercase sans-serif, slightly smaller and below main title",
      "position": "beneath title"
    }
  ],
  "graphic_elements": [],
  ...
  "post_processing": [
    "vibrancy enhancement on red background",
    "grain and ink texture overlay on illustration lines",
    "no drop shadows to preserve flat print aesthetic"
  ]
}

"Luminous Desert Cross" Prev and Ref: https://storage.googleapis.com/msgsndr/jI35EgXT0cs2YnriH7gl/media/68291fade5ca6c1eebf32ba4.jpeg
Prompt Modifier: {
  "scene": "desert landscape under a starry night sky with a luminous cross embedded in the sand, radiating light outward into the dunes",
  "image_dimensions": "1365×768",
  "aspect_ratio": "16:9 landscape",
  ...
  "lighting": "spotlight-style glow from the cross illuminating surrounding sand; soft starry ambiance in the sky",
  "mood": "hopeful, reverent, reflective—a visual meditation on resurrection and new life",
  "texture": [
    "fine grain overlay in the sand",
    "soft atmospheric haze around the cross glow",
    "subtle noise in the night sky"
  ],
  "background": {
    "elements": [
      "star-strewn indigo sky",
      "faint mountain ridge silhouette on horizon",
      "desert dunes with sparse shrubbery"
    ],
    "depth_of_field": "sharp foreground on cross and sand, softer background toward horizon"
  },
  "subjects": [
    {
      "type": "cross",
      "description": "white glowing cross emerging from desert floor, casting radial light",
      "position": "lower center"
    },
    {
      "type": "typographic element",
      "description": "'LIVE AGAIN' in oversized pink script, filling top half",
      "position": "center top, partially overlapping sky"
    },
    {
      "type": "typographic element",
      "description": "'FIND NEW LIFE' in small all-caps sans-serif",
      "position": "bottom center"
    }
  ],
  "graphic_elements": [],
  "typography": {
    "hierarchy": [
      {
        "text": "{LIVE AGAIN}",
        "font": "elegant high-loop script (e.g., Beloved, Citadel Script)",
        "weight": "light",
        "size": "extra large",
        "color": "#e7a4c5",
        "letter_spacing": "normal",
  ...
  "post_processing": [
    "Gaussian glow on cross",
    "star enhancement in sky layer",
    "slight color grading for dusk tones and harmony"
  ]
}
];