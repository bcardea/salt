...
const HomePage = () => {
  ...
  return (
    <div className="bg-white text-gray-900 font-sans">
      {/* Hero Section */}
      <section className="w-full px-4 sm:px-6 md:px-8 lg:px-12 pt-20 md:pt-28 pb-24 md:pb-32 bg-gradient-to-b from-secondary-50 to-white">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="lg:w-5/12 flex flex-col items-start justify-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <Link
                  to="/generator"
                  className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-secondary-900 rounded-full shadow-lg hover:bg-secondary-800 transition-all group"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-secondary-600 bg-white border border-secondary-200 rounded-full hover:bg-secondary-50 hover:text-secondary-900 transition-colors group"
                >
                  Watch Demo Video
              ...
              <div className="md:transform md:translate-x-4">
                ...
                <div className="relative mb-12 md:mb-16">
                  <img
                    src={saltyImage}
                    alt=""
                    className="absolute -left-6 sm:-left-8 top-1/2 -translate-y-1/2 w-20 sm:w-24 h-auto z-10"
                  />
                ...
                <div className="flex justify-center mb-12 md:mb-16">
                  <svg
                    className="w-8 h-16 text-secondary-300"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
                    <path
                    ...
                    <div key={img.src} className="flex flex-col items-center">
                      <div className="aspect-[3/2] w-full overflow-hidden rounded-xl">
                        <img
                          src={img.src}
                          alt={img.label}
                          className="w-full h-full object-cover rounded-xl shadow-md border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-lg"
                        />
                      </div>
      ...
      <section className="px-4 sm:px-6 md:px-8 lg:px-12 py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-secondary-900 mb-5">
            ...
            {ministryUsesCases.map((useCase, index) => (
              <div 
                ...
                className={useCase.chat 
                  ? "bg-white rounded-xl shadow-sm p-6 overflow-hidden border border-gray-100" 
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-8 flex justify-end">
                      <img
                        ...
                        alt=""
                        className="w-full max-w-[290px] h-auto rounded-lg shadow-sm"
                      />
                    </div>
                  </div>
                ) : (
